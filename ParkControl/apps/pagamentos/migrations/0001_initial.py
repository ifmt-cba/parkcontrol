    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ativo",
                    models.BooleanField(default=True, verbose_name="Ativo no Plano"),
                ),
                (
                    "email_para_cobranca",
                    models.EmailField(
                        ...
                        max_length=254,
                        null=True,
                        verbose_name="E-mail para Cobrança",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nome",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Nome da Tarifa"
                    ),
                ),
                (
                    "valor_inicial",
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=10,
                        verbose_name="Valor das Horas Adicionais",
                    ),
                ),
                (
                    "valor_diaria",
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=10,
                        null=True,
                        verbose_name="Valor Mensal Avulso",
                    ),
                ),
                (
                    "ativa",
                    models.BooleanField(default=True, verbose_name="Tarifa Ativa"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "placa_veiculo",
                    models.CharField(max_length=8, verbose_name="Placa do Veículo"),
                ),
                (
                    "hora_entrada",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Hora da Entrada"
                    ),
                ),
                (
                    "hora_saida",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Hora da Saída"
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=10,
                        null=True,
                        verbose_name="Valor Total Calculado",
                    ),
                ),
            ],
            options={
